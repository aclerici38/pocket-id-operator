...
var _ = Describe("PocketIDInstance Controller", func() {
	...
	Context("When creating a PocketIDInstance with Deployment type", func() {
		...
		BeforeEach(func() {
			...
			instance = &pocketidinternalv1alpha1.PocketIDInstance{
				...
				Spec: pocketidinternalv1alpha1.PocketIDInstanceSpec{
					...
					Image:          "ghcr.io/pocket-id/pocket-id:v2.16.0-distroless@sha256:f5ce1e58392f48a8fb8a1ff22a714272a49a52b8582d87deb530823f95359204",
		...
		It("Should create a Deployment", func() {
			...
			Expect(deployment.Spec.Template.Spec.Containers[0].Image).To(Equal("ghcr.io/pocket-id/pocket-id:v2.16.0-distroless@sha256:f5ce1e58392f48a8fb8a1ff22a714272a49a52b8582d87deb530823f95359204"))
	...
	Context("When updating a PocketIDInstance", func() {
		...
		It("Should update Deployment when image changes", func() {
			...
			Eventually(func() error {
				...
				instance.Spec.Image = "ghcr.io/pocket-id/pocket-id:v2.16.0-distroless@sha256:f5ce1e58392f48a8fb8a1ff22a714272a49a52b8582d87deb530823f95359204"
			...
			}, timeout, interval).Should(Equal("ghcr.io/pocket-id/pocket-id:v2.16.0-distroless@sha256:f5ce1e58392f48a8fb8a1ff22a714272a49a52b8582d87deb530823f95359204"))
		})
...
var _ = Describe("PocketIDInstance image defaulting", func() {
	...
	Context("When creating a PocketIDInstance that pins spec.image", func() {
		const pinned = "ghcr.io/pocket-id/pocket-id:v2.16.0-distroless"
